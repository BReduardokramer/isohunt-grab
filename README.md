...
**Do __not__ try to run multiple instances of the pipeline script on the same IP. The pipeline is hardcoded to a maximum concurrency of 12 threads; above this, Isohunt will __ban your IP__.** Just copypaste the pipeline commands below, and you will be fine.
...
7. `run-pipeline pipeline.py --concurrent 12 --port 8002 YOURNICKHERE`
...
then start downloading with:
    ...
    run-pipeline pipeline.py --concurrent 12 YOURNICKHERE
...
### For Debian/Ubuntu:
    ...
    screen su -c "cd /home/archiveteam/isohunt-grab/; run-pipeline pipeline.py --concurrent 12 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
6. `screen su -c "cd /home/archiveteam/isohunt-grab/; run-pipeline pipeline.py --concurrent 12 --address '127.0.0.1' YOURNICKHERE" archiveteam`
